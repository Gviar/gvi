...
def build_quote_sticker_image(text: str, author: str) -> BytesIO | None:
    ...
    while len(lines) > 9 and hasattr(font, "size") and font.size > 24:
    ...
    draw.ellipse((44, 44, 96, 96), fill=(73, 142, 255, 255))
    draw.text((59, 54), "Q", font=_load_font(26), fill=(255, 255, 255, 255))
    for ln in lines[:10]:
    ...
    draw.text((46, 450), f"— {author}", font=small, fill=(180, 220, 255, 255))
    bio = BytesIO()
    bio.name = "quote.webp"
