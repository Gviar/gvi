...
async def handle_ru_commands(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    game_commands = {
        ...
        'удар': raid_hit, 'рейд удар': raid_hit, 'слова': words_start,
    ...
    if text in game_commands:
        ...
        no_args = ['принять', 'согласен', 'отклонить', 'отказ', 'выстрел', 'стрель', 
                   ...
                   'удар', 'рейд удар', 'слова', 'стопслова', 'мопс', 'ежедневка', 'награда',
...
def build_application(token: str) -> Application:
    ...
    app.add_handler(CommandHandler("raid_weapons", raid_weapons))
    app.add_handler(CommandHandler("daily", daily))
    app.add_handler(CommandHandler("balance", balance))
    app.add_handler(CommandHandler("shop", shop))
    app.add_handler(CommandHandler("buy", buy))
    app.add_handler(CommandHandler("donate_shop", donate_shop))
    app.add_handler(CommandHandler("premium_buy", premium_buy))
    app.add_handler(CommandHandler("premium_buy_3m", premium_buy_3m))
    app.add_handler(CommandHandler("premium_buy_6m", premium_buy_6m))
    app.add_handler(CommandHandler("premium_buy_12m", premium_buy_12m))
    app.add_handler(CommandHandler("premium_status", premium_status))
    app.add_handler(CommandHandler("buy_stars", buy_stars))
    ...
    app.add_handler(CommandHandler("feed_mops", feed_mops))
...
def main() -> None:
    global marriages, duel_stats, war_stats, word_games, raid_states, daily_rewards, inventories, mops_state, duel_requests, active_duels, premium_users
